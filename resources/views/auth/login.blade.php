...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('public/css/bootstrap-grid.min.css') }} ">
	<link rel="stylesheet" type="text/css" href="{{ asset('public/css/bootstrap-reboot.min.css') }} ">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div>
                            <p>New User ? please register your account <a href="{{ route('register') }}">Here</a></p>
                        </div>
                    </form>
                </div>
            </div>
